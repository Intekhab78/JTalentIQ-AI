...
const { screenAndSubmitResume, getCompanyCandidates, updateInterviewStatus, rescreenCandidate, exportCandidatesData, downloadCandidateResume } = require('../controllers/candidateController');
